...
#define Mago_PATH "./imagens/SPRITES/Mago/spritesheet/Mago.png"
#define MAGO_VIDA 2000
#define MAGO_DANO 25
#define MAGO_VELOCIDADE 100
#define MAX_VAR_ALTURA 200
#define MAGO_ATAQUEX 500
...
public:
    Mago(sf::Vector2f pos = sf::Vector2f(0.f, 0.f), BolaDeFogo* boladefogo = NULL, Jogador* pJogador1 = NULL, Jogador* pJogador2 = NULL, int minH = 0, int maxH = 0);
    ~Mago();
